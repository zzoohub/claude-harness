...
export type {
  Agent, HookEvent, HookInput, HookOutput,
...
export {
  ...
  isActive, startMode, endMode,
  transition, isLastPhase,
  updateData, getData,
  type SessionState, type TransitionResult,
} from './core/state.js';
...
export {
  ...
  type LoopConfig, type PipelineConfig,
} from './hooks/modes.js';

export {
  readMemory, addPriority, addWorking, addManual,
  pruneWorking, clearMemory, formatMemory,
  createMemoryHook, createMemoryCapture,
...
export {
  runTeam, getTeamStatus, killTeam,
  type TeamTask, type TeamConfig, type TeamReport, type TaskResult,
} from './runtime/team.js';

// ---------------------------------------------------------------------------
// Harness factory
// ---------------------------------------------------------------------------

export { createHarness, type Harness } from './core/harness.js';
